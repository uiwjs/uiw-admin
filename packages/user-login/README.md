...
| 参数          | 必填 | 类型                                                          | 默认值                                      | 说明                                                               |
| :------------ | :--- | :------------------------------------------------------------ | :------------------------------------------ | :----------------------------------------------------------------- |
| align         | 否   | `'left' | 'right' | 'center'`                                 | `center`                                    | 卡片框的位置                                                       |
| footer        | 否   | `React.ReactNode`                                             | undefined                                   | 页脚                                                               |
| bg            | 否   | `string`                                                      | undefined                                   | 页面背景                                                           |
| children      | 否   | `React.ReactNode`                                             | undefined                                   | 替换卡片位置内容                                                   |
...
| styleWarp     | 否   | `React.CSSProperties`                                         | undefined                                   | 卡片框外层`style`                                                  |
| classNameBody | 否   | `string`                                                      | undefined                                   | 卡片框`className`                                                  |
| styleBody     | 否   | `React.CSSProperties`                                         | undefined                                   | 卡片框`style`                                                      |
