  ...
  render() {
    return (
      <PageHeaderLayout title="Ellipsis文本自动省略号" content="文本过长自动处理省略号，支持按照文本长度和最大行数两种方式截取。">
        <Card className={styles.cardItem} title="通过设置 length 属性指定文本最长长度，如果超过这个长度会自动截取。" noHover>
        ...
        <Card className={styles.cardItem} title="通过设置 tootip 属性,当鼠标移动到省略文本处可查看全部文本。" noHover>
          <div>原始文本：亮金大气亮金大气亮金大气亮金大气亮金大气</div>
          <Ellipsis length={10} tooltip>亮金大气亮金大气亮金大气亮金大气亮金大气</Ellipsis>
        </Card>
        <Card className={styles.cardItem} title="通过设置 tootip 属性,当鼠标移动到省略文本处可查看全部文本。" noHover>
