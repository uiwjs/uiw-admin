...
import { Card, Icon, Row, Col, Steps, Button } from 'uiw';
  ...
  render() {
    const desc1 = (
      <div style={{ fontSize: 12, color: 'rgba(0, 0, 0, 0.45)', position: 'relative', left: 42 }}>
        <div style={{ margin: '8px 0 4px' }}>
          uiw<Icon style={{ marginLeft: 8 }} type="dingding-o" />
        </div>
    ...
    const desc2 = (
      <div style={{ fontSize: 12, position: 'relative', left: 42 }}>
        <div style={{ margin: '8px 0 4px' }}>
          安安<Icon type="dingding-o" style={{ color: '#00A0E9', marginLeft: 8 }} />
        </div>
    ...
    const extra = (
      <div>
        ...
        <Steps style={{ marginLeft: -42, width: 'calc(100% + 84px)' }} progressDot current={1}>
          <Steps.Step title={<span style={{ fontSize: 14 }}>创建项目</span>} description={desc1} />
          <Steps.Step title={<span style={{ fontSize: 14 }}>部门初审</span>} description={desc2} />
          <Steps.Step title={<span style={{ fontSize: 14 }}>财务复核</span>} />
          <Steps.Step title={<span style={{ fontSize: 14 }}>完成</span>} />
        </Steps>
      </div>
    );
